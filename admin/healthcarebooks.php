                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="healthcarebooks.php">Health care services and facilities</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							$result= mysqli_query($conn ,"SELECT * FROM book where status = 'Health care services and facilities'") or die (mysqli_error());
