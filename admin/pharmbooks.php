                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="pharmbooks.php">Pharmaceuticals & Related Segments</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							$result= mysqli_query($conn ,"SELECT * FROM book where status = 'Pharmaceuticals & Related Segments'") or die (mysqli_error());
