                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="user_edubooks.php">Education</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							$result= mysqli_query($db ,"SELECT * FROM book where status = 'Education'") or die (mysqli_error());
