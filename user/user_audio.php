...
<?php include ('user_header.php'); ?>
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								<li role="presentation" class="active"><a href="user_audio.php">All</a></li>
	...
	<div class="agile_top_brands_grids">
        ...
        $total_pages = ceil($total_rows / $no_of_records_per_page);
         ...
         $sql = "SELECT * FROM audio order by audio_id LIMIT $offset, $no_of_records_per_page";
