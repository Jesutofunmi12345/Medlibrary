...
<?php include ('user_header.php'); ?>
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="user_healthdevicesbooks.php">Health devices and equipments</a></li>
	...
	<div class="agile_top_brands_grids">
        ...
        $total_pages_sql = "SELECT COUNT(*) FROM book WHERE status='Health devices and equipments'";
        $result = mysqli_query($conn,$total_pages_sql);
        $total_rows = mysqli_fetch_array($result)[0];
        $total_pages = ceil($total_rows / $no_of_records_per_page);

         $sql = "SELECT * FROM book WHERE status='Health devices and equipments' LIMIT $offset, $no_of_records_per_page";
