                ...
                <div class="x_panel">
                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" class="active"><a href="user_techbooks.php">Technical Education</a></li>
								<li role="presentation"><a href="user_vocbooks.php">Vocational Education</a></li>
								<li role="presentation"><a href="user_artsbooks.php">Arts & Social sciences</a></li>
                    ...
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							$result= mysqli_query($db ,"SELECT * FROM book where status = 'Technical Education'") or die (mysqli_error());
