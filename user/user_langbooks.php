                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" ><a href="user_artsbooks.php">Arts & Social sciences</a></li>
							 	<li role="presentation" class="active"><a href="user_langbooks.php">Languages</a></li>
							</ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							$result= mysqli_query($db ,"SELECT * FROM book where status = 'Languages'") or die (mysqli_error());
