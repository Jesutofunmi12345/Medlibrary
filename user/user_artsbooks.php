                    ...
                    <div class="x_title">
                        ...
                        <div class="clearfix"></div>
							<ul class="nav nav-pills">
								...
								<li role="presentation" ><a href="user_edubooks.php">Education</a></li>
								<li role="presentation" ><a href="user_scibooks.php">Sciences</a></li>
								<li role="presentation"><a href="user_techbooks.php">Technical Education</a></li>
								<li role="presentation" ><a href="user_vocbooks.php">Vocational Education</a></li>
								<li role="presentation" class="active"><a href="user_artsbooks.php">Arts & Social sciences</a></li>
							 	<li role="presentation"><a href="user_langbooks.php">Languages</a></li>
							</ul>
                        <div class="clearfix"></div>
                    </div>
                    <div class="x_content">
						...
						<div class="table-responsive">
							...
							$result= mysqli_query($db ,"SELECT * FROM book where status = 'Arts & Social sciences'") or die (mysqli_error());
							...
							<tr>
								...
								<?php else: ?>
								<img src="images/book_image.jpg" class="img-thumbnail" width="700px" height="500px">
								<?php endif; ?>
								...
								<td>
									<a class="btn btn-primary" for="ViewAdmin" href="userview_book.php<?php echo '?book_id='.$book_id; ?>">
